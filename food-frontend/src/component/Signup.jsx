...
function Signup() {
    ...
    return (
        <>
            <div className="min-h-[91vh] mt-[10vh] w-full bg-[#E0E0E0] flex flex-col items-center justify-center px-4">
                <div ref={refsignup} className={`signup ${signupVisiblep ? "showSu" : ""} bg-white lg:h-[80vh] lg:w-[68vw] w-full rounded-[2vh] flex items-center justify-center lg:p-2 p-4 shadow-gray-500 shadow-2xl`}>
